--
-- Dynamic Leenium Theme Menu for Elephant/Walker
--
Name = "leeniumthemes"
NamePretty = "Leenium Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/leenium/themes"
  local leenium_path = os.getenv("LEENIUM_PATH") or ""
  local default_theme_dir = leenium_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "leenium-theme-set " .. theme_name,
            },
          })
        end
      end
