Name = "leeniumBackgroundSelector"
NamePretty = "Leenium Background Selector"
Cache = false
...
function GetEntries()
  ...
  local theme_name_file = io.open(home .. "/.config/leenium/current/theme.name", "r")
  ...
  local dirs = {
    home .. "/.config/leenium/current/theme/backgrounds",
  }
  if theme_name then
      ...
      for background in handle:lines() do
        ...
        if filename and not seen[filename] then
          ...
          table.insert(entries, {
            ...
            Value = background,
            Actions = {
              activate = "leenium-theme-bg-set " .. ShellEscape(background),
            },
            Preview = background,
            PreviewType = "file",
          })
