...
if [[ -f /usr/share/libalpm/hooks/80-limine-efi-deploy.hook ]]; then
  sudo mv /usr/share/libalpm/hooks/80-limine-efi-deploy.hook /usr/share/libalpm/hooks/80-limine-efi-deploy.hook.disabled
fi

echo "mkinitcpio and Limine deploy hooks disabled"
